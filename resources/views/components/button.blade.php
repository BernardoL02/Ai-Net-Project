...
@php
    $colors = match($type) {
        'primary' => 'inline-flex items-center px-4 py-2 bg-red-700 dark:bg-gray-200 border
        ...
        'black'     => 'inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border
                        border-transparent rounded-md font-semibold text-sm text-white
                        dark:text-gray-800 tracking-widest hover:bg-gray-700 dark:hover:bg-white
                        focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300
                        focus:outline-none focus:ring-2 focus:ring-indigo-500
                        focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150',
        'secondary' => 'text-white dark:text-gray-700 text-sm
        ...
        'success' => 'text-white dark:text-gray-900 text-sm
        ...
        'danger' => 'text-white dark:text-gray-900 text-sm
        ...
        'info' => 'text-gray-900 dark:text-gray-200 text-sm
        ...
        'light' => 'text-gray-900 dark:text-gray-200 text-sm
        ...
        'link' => 'text-blue-500 text-sm
                        border-gray-200',
        default => 'text-white dark:text-gray-900 text-sm
